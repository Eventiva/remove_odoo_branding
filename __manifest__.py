...
- Supports HTML formatting for disclaimers, legal text, or custom branding
    ...
    # The following modules have optional template inheritance (will load if available):
    # auth_signup, crm, digest, event, gamification, hr_attendance, hr_expense,
    # im_livechat, lunch, marketing_card, mass_mailing, mass_mailing_crm,
    # mass_mailing_sale, point_of_sale, pos_sale, website_crm_partner_assign,
